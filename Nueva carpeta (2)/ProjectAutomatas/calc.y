...
LIBS		: GATO INCLUDE MENORQUE ID MAYORQUE {printf("LIBRERIA"); libreria++;}
			| GATO INCLUDE CADENA {printf("LIBRERIA"); libreria++;}
			;
...
FUNCIONES	: VARIABLE ID PARENTESISIZ PARENTESISDER  {printf("FUNCION"); funcion++;}
			...
			| ID PARENTESISIZ ID PARAMETROS PARENTESISDER  PUNTOCOMA{printf("FUNCION2");  funcion++;}
			| ID PARENTESISIZ PARENTESISDER  PUNTOCOMA{printf("FUNCION2");  funcion++;}
			;

DECLARACION : VARIABLE BRACKETIZ BRACKETDER ID VAR PUNTOCOMA {printf("DECLARACION");}
			| VARIABLE ID VAR PUNTOCOMA {printf("DECLARACION");}
			| VARIABLE ASIGNACION
			;
